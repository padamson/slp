...
- **H1.1 — draw the outline**
  - [ ] click in the yard to drop corners; close the loop to finish the outline
  - [ ] the drawn house is saved to the `Plan` and survives a reload
  - [ ] the house is flagged **existing** by default (not costed)
- **H1.2 — place doors & windows**
