...
| M1–M3 | *Enabler:* materials/catalog + cost engine (folded into E1) | [E1](E1-place-furniture.md) | 🚧 schema + model (cost engine next) |
| E1 | Place deck furniture (look + cost) | [E1](E1-place-furniture.md) | 🚧 schema + model (cost engine next) |
