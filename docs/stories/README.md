...
| G1 | *Enabler:* save/load `.slp.json` | [G1](G1-save-load-plan.md) | ✅ done (download/upload + File System Access API Save-As/reopen) |
...
| R4 | Photorealistic AI preview (impression) | [R4](R4-photorealistic-preview.md) | 🚧 R4.0–R4.4 done (Preview button, Overhead img2img + Eye-level, local Z-Image via SwarmUI); + From-photo (R4.6) + download/gallery (R4.5); next: per-item photo descriptions, richer raster (R4.7) |
